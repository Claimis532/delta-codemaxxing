...
import { containerClass, projectCategories, type ProjectCategory } from "@/constants/content";
import { BrandOrbitCluster } from "@/components/BrandDecor";

interface ProjectsSectionProps {
    onOpenCategory: (category: ProjectCategory) => void;
}

export const ProjectsSection = ({ onOpenCategory }: ProjectsSectionProps) => (
